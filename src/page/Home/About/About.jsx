...
const About = () => {
    return (
        <div className="py-24">
            <h1 className=" text-4xl lg:text-5xl pb-14 font-bold lg:pt-14 lg:pb-24 text-white text-center">know us</h1>
            <div className="lg:flex w-full justify-between gap-10 items-center">
                <div className="lg:w-1/2 w-full"><img className=' mx-auto w-full rounded-xl lg:w-3/4' src={aboutImg} alt="" /></div>
                <div className="lg:w-1/2 mt-14 lg:mt-0 w-full">
                    <h1 className="text-4xl lg:text-5xl text-primary pb-8 font-bold">About Us</h1>
                    <p>
